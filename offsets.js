...
namespace Offsets {
    ...
    namespace FFlags {
         inline constexpr uintptr_t DesyncReplicatorOffset = 0x75F5F38;
    }

    namespace NetworkSettings {
         inline constexpr uintptr_t InboundLoss = 0x10;
         inline constexpr uintptr_t IncomingReplicationLag = 0x20;
    }
